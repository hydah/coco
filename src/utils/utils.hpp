 ...
 *
 * @remark the MyClass can be basic type, for instance, CocoAutoFreeA(char, pstr),
...
extern int write_large_iovs(IBufferWriter* skt, iovec* iovs, int size, ssize_t* pnwrite);
#endif